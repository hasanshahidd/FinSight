...
Vague goals like "save more" or "spend less" fail. Specific goals with a number, a deadline, and a system succeed.

## Use the SMART framework

A useful goal is **Specific**, **Measurable**, **Achievable**, **Relevant**, and **Time-bound**.
...
Match the savings vehicle to the time horizon:

- **Short-term (< 2 years)**: HYSA, money market, short-term Treasuries. Capital preservation.
- **Medium-term (2–7 years)**: 60/40 stock-bond portfolio or CD ladders for known dates.
- **Long-term (7+ years)**: Equity-heavy index portfolio. Volatility smooths over time.

A common error is using the same account for all three.
...
5. Max Roth IRA, then 401(k).
6. Save for medium-term goals (house, car, kids' education).
7. Taxable brokerage for early retirement / financial independence.

Steps 1–2 are non-negotiable. Steps 3–7 can flex based on personal priorities.
...
- Was a windfall (tax refund, bonus) routed to goals before checking?
